		...
		<motion.div
			...
			<div className='  min-h-screen h-full w-full  bg-[#8fd82f] p-10 pt-28 z-[49] overflow-y-scroll'>
				<Flex
					...
					justify='center'
					css={{
						backgroundImage: useColorModeValue(CONFETTI_DARK),
									...
									<Stack
										...
										<Tooltip
											...
											<IconButton
												...
												onClick={(e) => {
													setValue("sanketsapatevnit@gmail.com");
													onCopy();
												}}
												isRound
											/>
										...
										<Link href='https://github.com/sanket-sapate'>
											<IconButton
												aria-label='github'
												variant='ghost'
												size='lg'
										...
										<Link href='https://www.linkedin.com/in/sanket-sapate-205a22183/'>
											<IconButton
												aria-label='linkedin'
												variant='ghost'
												size='lg'
